...
const RegisterDoctor=asyncHandler(async(req,res)=>{
 ...
 const LogoutPatient=asyncHandler(async(req,res)=>{
      ...
      return res.status(200)
      .clearCookie("AcessToken",AccessToken,options)
...
const RefreshAcessAndRefreshTokenForPatient=asyncHandler(async(req,res)=>{
     ...
     .cookie("RefreshToken",RefreshToken,options)
     .json(
        new ApiResponse("tokens Refreshed Sucessfully",200,{AccessToken,RefreshToken})
     )
})
...
export {
    RegisterDoctor,RegisterPatient,LogoutDoctor,LogoutPatient,PatientLogin,DoctorLogin,RefreshAcessAndRefreshTokenForPatient,RefreshAcessAndRefreshTokenForDoctor
}
